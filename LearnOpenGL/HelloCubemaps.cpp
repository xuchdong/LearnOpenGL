...
//  LearnOpenGL
//
//  Created by xuchdong on 2018/8/2.
...
string skyboxBasePath = "/Users/xuchdong/xuchdong/LearnOpenGL/src/skybox/";
string srcBasePath = "/Users/xuchdong/xuchdong/LearnOpenGL/src/";

unsigned int cubemapTexture, cubeTexture;
unsigned int vao, vbo;
unsigned int cubeVAO, cubeVBO;
Shader *skyboxShader, *cubeShader;
...
unsigned int loadCubemap(vector<string> faces)
{
    ...
    {
        unsigned char* data = stbi_load((skyboxBasePath + faces[i]).c_str(), &width, &height, &nrChannels, 0);
        if(data)
        {
