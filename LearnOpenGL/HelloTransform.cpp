...
//  LearnOpenGL
//
//  Created by xuchdong on 2018/7/23.
...
void init(GLFWwindow* window)
{
    ...
    realPath = basePath + "awesomeface.png";
    data = stbi_load(realPath.c_str(), &width, &height, &nrChannels, 0);
    if(data)
    {
    ...
    shader = new Shader("hello_transform.vs", "hello_transform.fs");
